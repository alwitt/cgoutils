...
func TestSodiumAEADAES256GCMBasic(t *testing.T) {
	assert := assert.New(t)
	...
	testAEADType := crypto.AEADTypeAes256gcm
...
func TestSodiumAEADAES256GCMMultiMsg(t *testing.T) {
	assert := assert.New(t)
	log.SetLevel(log.DebugLevel)
...
func TestSodiumAEADAES256GCMOutOfOrderMessage(t *testing.T) {
	assert := assert.New(t)
	log.SetLevel(log.DebugLevel)
...
func TestSodiumAEADAES256GCMCorruptedMessage(t *testing.T) {
	assert := assert.New(t)
	log.SetLevel(log.DebugLevel)
...
func TestSodiumAEADAES256GCMAdditionalData(t *testing.T) {
	assert := assert.New(t)
	log.SetLevel(log.DebugLevel)
...
func TestSodiumAEADAES256GCMThroughPut(t *testing.T) {
	assert := assert.New(t)
